...
import { LayoutDashboard, BotMessageSquare, Mic, GraduationCap, Beaker, Route, Users, TrendingUp, Globe, Target, BookText, Settings } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ currentPage, setCurrentPage }) => {
  return (
    <aside id="sidebar" className="w-64 flex flex-col bg-card border-r border-border">
